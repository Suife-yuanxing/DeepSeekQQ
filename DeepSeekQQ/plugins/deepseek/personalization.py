...
# 关系风格 → 昵称偏好
_STYLE_NICKNAMES = {
    "tsundere": {500: ["笨蛋", "哼，亲爱的"], 200: ["笨蛋", "傻瓜"], 100: ["你这笨蛋"]},
    "gentle": {500: ["亲爱的", "宝贝"], 200: ["乖乖", "小可爱"], 100: ["你呀"]},
    "polite": {500: ["亲爱的"], 200: ["你"], 100: ["你"]},
}
...
_BOT_INTERESTS = {"猫", "奶茶", "游戏", "音乐", "番剧", "零食", "可爱的东西"}
...
# 好感度阶段描述
_GROWTH_STAGES = [
    (500, "命定之人", "你已经完全离不开他了，他是你生命里最重要的人"),
    (200, "重要的人", "他在你心里有特别的位置，你很在意他的一举一动"),
    (100, "喜欢的人", "你对他有特别的好感，看到他的消息会心跳加速"),
    (50, "有点在意", "你开始在意他了，会不自觉地关注他"),
...
_STYLE_CATCHPHRASE_FREQ = {
    ...
    "gentle": {"诶嘿": 0.15, "喵~": 0.10, "嘛~": 0.10, "嘿嘿": 0.08},
...
def get_personalized_catchphrase(
    ...
    if relationship_style in _STYLE_CATCHPHRASE_FREQ:
        ...
        pool = {"诶嘿": 0.10, "哼": 0.08, "喵~": 0.06, "嘛~": 0.06}
